...
from .models import GoalSetting, IdeaMemo, MonthlyGoal, Profile, TodayTask, WeeklyGoal, YearlyGoal, YearPlan
...
class YearPlanAdmin(admin.ModelAdmin):
    list_display = ("user", "list_title", "year", "target_count", "is_public")
...
class YearlyGoalAdmin(admin.ModelAdmin):
    list_display = ("title", "user", "category", "completed_date", "is_done", "is_public", "item_is_public", "created_at")
